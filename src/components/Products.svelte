<script>
  ...
  let productFeatures = [
    ...
    },
    {
      ...
      description:
        "Enter as much information about yourself as you desire to ensure all workouts are personalized to your every needs.",
...
<SectionWrapper id="product">
  <div
    class="flex flex-col gap-10 sm:gap-14 md:gap-20 flex-1 items-center justify-center pb-10 md:pb-14"
  >
    <div class="flex flex-col gap-2">
      <p class="opacity-60 text-base sm:text-lg md:text-xl text-center">
        Start your lifetime <span class="text-indigo-400">journey</span> today
      </p>
      <h3
